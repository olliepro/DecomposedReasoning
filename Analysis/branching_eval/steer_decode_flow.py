...
POST_THINK_CONTINUATION_MAX_TOKENS = 512
    ...
    *,
    ...
    steer_choice = await executor._generate_choice_async(
        ...
        stop=steer_candidate_stop_markers(
            ...
            use_full_stop_strings=executor.branching.use_full_stop_strings,
        ),
        n=1,
    ...
    steer_candidate_text, steer_candidate_token_ids = (
        await executor._append_think_close_stop_suffix_async(candidate=steer_candidate)
    )
    ...
    if steer_candidate_has_decision_tag(
        ...
        updated_prompt_ids = append_prompt_token_ids(
            prompt_token_ids=canonical_prompt_ids,
            continuation_token_ids=steer_token_ids,
        )
    executor._update_request_stream_state_output_ids(
        request_stream_id=request_stream_id,
