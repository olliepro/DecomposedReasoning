...
class TreeNode:
    ...
    Args:
        ...
        branch_token_offset: Optional generated-token offset where the incoming
            branch edge starts receiving segment credit.
    ...
    branch_token_offset: int | None = None
...
class LeafRollout:
    ...
    Args:
        ...
        steer_phase_token_spans: Response-token spans generated by steer-phase requests.
        off_policy_token_spans: Response-token spans inserted synthetically and
            excluded from actor updates.
